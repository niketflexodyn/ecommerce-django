...
class ProductManufacturingDetails(models.Model):
    product = models.OneToOneField(
        Product,
        on_delete=models.CASCADE,
        related_name="manufacturing_details"
    )
    ...
    def __str__(self):
        return f"Manufacturing Details - {self.product.name}"
...
class PriceFilterRange(models.Model):
