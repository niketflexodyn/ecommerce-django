      ...
      <section id="products" className="page-container py-10 sm:py-12">
        ...
        <div className="mb-6 flex gap-2 overflow-x-auto pb-1 lg:hidden">
          <button
            ...
            className={`shrink-0 rounded-full px-5 py-2 text-sm font-semibold transition ${selectedCategory === 'all'
          ...
          <aside className="hidden w-56 shrink-0 lg:block">
            <div className="sticky top-32">
              ...
              <div className="space-y-1">
                <button
                  onClick={() => updateCategory('all')}
                  className={`flex w-full items-center rounded-lg px-4 py-2.5 text-sm font-medium transition ${selectedCategory === 'all'
                    ? 'bg-plum-950 text-white'
            ...
            <div className="mb-8 flex flex-wrap items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  {loading
                    ? 'Loading...'
                    : `${totalCount} item${totalCount !== 1 ? 's' : ''}${activeSubcategory
                    ...
                    {pageNumbers.map((p, i) =>
                      p === '…' ? (
                        ...
                        <button
                          key={p}
                          onClick={() => setPage(p)}
                          className={`rounded-lg px-3 py-2 text-sm font-medium transition ${p === currentPage
                            ? 'bg-plum-950 text-white'
